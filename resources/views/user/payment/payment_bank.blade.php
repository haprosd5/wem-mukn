                ...
                <div class="col-lg-9 col-md-12 col-xs-12 pb-2">
                    ...
                    <div id="smartwizard" class="sw-main sw-theme-dots stepwizard p-4 border sw-theme-none">
                        ...
                        <ul class="nav nav-tabs step-anchor">
                            ...
                            <li class="nav-item active"><a href="#step-1" class="nav-link">Bước 1<br>
                                    <small>Step 1</small>
                                </a></li>
                            <li class="nav-item"><a href="#step-2" class="nav-link">Hoàn thành<br>
                                    <small>Step 2</small>
                                </a></li>
                        </ul>
                        ...
                        <div class="sw-container tab-content" style="min-height: 0px;">
                            ...
                            <div id="step-2" class="tab-pane step-content">
                                ...
                                <ul style="background-color: #fcf8e3" class="list-group p-3">
                                    ...
                                    <li class="list-group-item font-weight-bold">Ngân hàng: <img data-toggle="tooltip"
                                                                                                 data-html="true"
                                                                                                 data-placement="top"
                                                                                                 title=""
                                                                                                 data-original-title="Joint Stock Commercial Bank for Foreign Trade of Vietnam"
                                                                                                 class="mb-3"
                                                                                                 src="/assets/img/payment-logo/vietcombank-logo.png"
                                                                                                 width="100px"></li>
                                    <li class="list-group-item font-weight-bold">Tên chủ khoản: <span
                                                class="badge-info p-1">Huỳnh Ngọc Ân Trạch</span></li>
                                    <li class="list-group-item font-weight-bold">Chi nhánh: <span
                                                class="badge-info p-1">Bắc Gia Lai</span></li>
                                    <li class="list-group-item font-weight-bold">Số tài khoản: <span
                                                class="badge-info p-1">0291000318544</span></li>
                                    <li class="list-group-item font-weight-bold">Số tiền: <span id="payment_amount"
                                                                                                class="badge-success p-1">lỗi</span>
                                    </li>
                                    <li class="list-group-item font-weight-bold">Nội dung: <span id="payment_id"
                                                                                                 class="badge-danger p-1">lỗi</span>
                                    </li>
                                </ul>

                                <div class="text-center">
                                    <button id="submitPayment" class="btn btn-info mt-2" onclick="confirmMsg();"><i
                            ...
                            <div id="step-1" class="tab-pane step-content" style="display: block;">
                                <div class="alert alert-info"
                                     style="margin:10px 0 15px 0; /*padding:5px 5px 5px 15px;*/">
                                    <i class="fa fa-info-circle"></i> <a target="_blank" href="khuyenmai.html">Click xem
                                        hướng dẫn nạp qua Ngân hàng.</a>
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="confirmAmount">Nhập số tiền muốn nạp</label>
                                            <input type="tel" class="form-control" id="confirmAmount"
                                                   placeholder="Chọn để nhập" required="" maxlength="19">

                                            <div class="text-info pt-2">Xu thực nhận: <span id="coinReceive">0</span>
                                            </div>
                                            <div class="text-info pt-2">Lượt quay tặng thêm: <span
                                                        id="turnReceive">0</span></div>
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="alert alert-warning fade in alert-dismissible show">
                                            ...
                                            <strong>Lưu ý: </strong> Số tiền phải là số lớn hơn 10,000 và chia hết cho
                                            1,000.
                                        </div>
