        ...
        <div class="content-header row">
            <div class="content-header-left col-12 mb-2 mt-1">
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        <h5 class="content-header-title float-left pr-1 mb-0">List Event</h5>
                            ...
                            <div class="card-content">
                                <div class="card-body pb-0 mx-25">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <form id="jquery-val-form" method="post" enctype="multipart/form-data" action="admin/event/add-event">
                                                @csrf
