...
-->
        <div class="row pt-3">
            <div class="col-lg-9 col-md-12 col-xs-12 pb-2">
                <div id="smartwizard" class="sw-main sw-theme-dots stepwizard p-4 border">
                    ...
                    <ul>
                        ...
                        <li><a href="#step-1">Bước 1<br /><small>Step 1</small></a></li>
                        <li><a href="#step-2">Hoàn thành<br /><small>Step 2</small></a></li>
                    </ul>
                    ...
                    <div>
                        ...
                        <div id="step-2" class="">
                            ...
                            <p><b>Bước 1</b>: Bạn hãy <img width="25"
                                    src="https://img.mservice.io/momo-payment/icon/cdn/material/img/qr-code-1.png"
                                    alt=""><b> Quét mã</b> dưới đây bằng ứng dụng <b>Momo</b>.<br>Hoặc chọn mục
                                <b>Chuyển tiền</b> <i class="fa fa-arrow-right"></i> <b>Chuyển tiền đến ví MoMo</b>
                                Nhập số điện thoại:
                                <span class="badge-warning p-1 font-weight-bold">0332699443</span>
                            </p>
                            <div class="row">
                            ...
                            <ul style="background-color: #fcf8e3" class="list-group p-3">
                                ...
                                <li class="list-group-item font-weight-bold">Số tiền : <span id="payment_amount"
                                        class="badge-success p-1">lỗi</span></li>
                                <li class="list-group-item font-weight-bold">Nội dung tin nhắn : <span id="payment_id"
                                        class="badge-danger p-1">lỗi</span></li>
                            </ul>

                            <div class="text-center"><button id="submitPayment" class="btn btn-info mt-2"
                                    onclick="confirmMsg();"><i class="fa fa-check-circle" aria-hidden="true"></i>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="alert alert-warning fade in alert-dismissible show">
                                        ...
                                        </button> <strong>Lưu ý!</strong> Số tiền phải là số lớn hơn 10,000 và chia
                                        hết cho 1,000.
                                    </div>
                                    <div class="alert alert-info"
                                        style="margin:10px 0 15px 0; /*padding:5px 5px 5px 15px;*/">
                                        <i class="fa fa-info-circle"></i>
                                        <a data-toggle="modal" data-target="#exampleModal">Click xem hướng dẫn
                                            nạp qua Momo.</a>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="tel" class="form-control" id="confirmAmount"
                                            placeholder="Chọn để nhập" required>

                                        <div class="text-info pt-2">Xu thực nhận: <span id="coinReceive">0 </span>
                                        </div>
                                        <div class="text-info pt-2">Lượt quay tặng thêm: <span id="turnReceive">0
                                            </span></div>
                                    </div>
                                </div>
                            </div>
